...
class node3
{
    ...
    /*  Function to set link to next node3  */
    public void setLink(node3 n)
    {
        link = n;
    }
    /*  Function to set data to current node3  */
    public void setData(int d)
    {
        data = d;
    }
    /*  Function to get link to next node3  */
    public node3 getLink()
    {
        return link;
    }
    /*  Function to get data from current node3  */
    public int getData()
    {
        return data;
    }
